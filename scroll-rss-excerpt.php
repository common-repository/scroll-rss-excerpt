...
function srsse_shortcode( $atts ) 
{
	...
	if ( ! is_wp_error( $rss ) )
	{
		...
		if ( $maxitems > 0 )
		{
			...
			$srsse_scrollheight = $srsse_scrollheight + 0;
...
function srsse_init()
{
	...
	{
		wp_register_sidebar_widget( 'scroll-rss-excerpt', __('Scroll rss excerpt', 'scroll-rss-excerpt'), 'srsse_widget');
	}
	
	if(function_exists('wp_register_widget_control')) 
	{
		wp_register_widget_control( 'scroll-rss-excerpt', array( __('Scroll rss excerpt', 'scroll-rss-excerpt'), 'widgets'), 'srsse_control');
	} 
}
